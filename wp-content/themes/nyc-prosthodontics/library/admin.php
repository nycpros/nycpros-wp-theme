...
function my_custom_login_logo() {
	if ( get_field('login_logo', 'options') ) { // look for a custom login logo from ACF
     echo '<style type="text/css">                                                                   
         h1 a { background-image:url('.get_field('login_logo', 'options').') !important; 
     </style>';
	}
}
...
// UNCOMMENT BELOW TO CUSTOMIZE ADMIN FOOTER
